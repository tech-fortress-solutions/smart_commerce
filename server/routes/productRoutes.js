...
// product routes
router.post('/create', authMiddleware, upload.fields([{ name: 'thumbnail', maxCount: 1 }, { name: 'images', maxCount: 10 }]), createProductController);
router.get('/all', getAllProductsController);
router.get('/search', searchProductsController);
router.delete('/delete/:id', authMiddleware, deleteProductController);
router.put('/update/:id', authMiddleware, upload.fields([{ name: 'thumbnail', maxCount: 1 }, { name: 'images', maxCount: 10 }]), updateProductController);
