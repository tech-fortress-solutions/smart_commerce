...
const SingleProductPage: FC = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
                  ...
                  <div className="border-b pb-6 last:border-b-0">
                    ...
                    {user?.role === 'admin' && adminReply.reviewId === review._id && (
                        <div className="mt-4 p-4 bg-background border rounded-lg">
                            <h5 className="font-semibold text-sm mb-2">Admin Reply</h5>
                            <Textarea
                            ...
                            <div className="flex justify-end gap-2">
                                <Button
                                    variant="outline"
                                    onClick={() => setAdminReply({ reviewId: null, comment: '' })}
                                >
                                    Cancel
                                </Button>
                                <Button
                    ...
                    {review.response && (
                      <div className="mt-4 p-3 bg-secondary/50 rounded-lg border-l-4 border-blue-500">
                        <p className="font-semibold text-sm text-blue-600 mb-1">Vendor Response</p>
      ...
      {/* Buy Now Dialog for the main product */}
      {product && (
        <BuyNowDialog
          isOpen={isBuyNowDialogOpen}
